...
const printCardsCtrl   = require('../controllers/adminPrintCardsController');
...
router.get('/groups/import',      requireSuperAdmin, importCtrl.importPage);
router.post('/groups/import',     requireSuperAdmin, importCtrl.importExecute);
...
router.get('/backups/export',       requireSuperAdmin, backupCtrl.exportDirect);
...
router.get('/student-achievements/print-cards',  printCardsCtrl.printCards);
